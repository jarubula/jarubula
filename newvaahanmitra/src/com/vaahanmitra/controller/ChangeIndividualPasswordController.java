...
/**
 * Servlet implementation class ChangeIndividualPasswordController
 */
public class ChangeIndividualPasswordController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeIndividualPasswordController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (newpwd.equals(repwd)) {
			...
			if(change == false){
				...
				RequestDispatcher rd = request.getRequestDispatcher("./changeIndividualOwnerPassword.jsp");
