...
/**
 * Servlet implementation class UsedBikeController
 */
@javax.servlet.annotation.MultipartConfig
public class UsedBikeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsedBikeController() {
        super();
