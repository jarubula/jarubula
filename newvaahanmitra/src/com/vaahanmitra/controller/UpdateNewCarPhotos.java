...
/**
 * Servlet implementation class UpdateNewCarPhotos
 */
@javax.servlet.annotation.MultipartConfig
public class UpdateNewCarPhotos extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public UpdateNewCarPhotos() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 message = dao.updateCarPhotos(carNo, is, al);}
		else{message = dao.addNewCarPhotos(carNo, is, al);}
		if (message.equals("success")) {
				message = "Photos are updated on '"+carNo+"'";
		}
		RequestDispatcher rd = request.getRequestDispatcher("./updateNewCarPhotos.jsp");
