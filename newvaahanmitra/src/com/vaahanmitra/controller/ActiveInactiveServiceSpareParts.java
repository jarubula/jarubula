...
public class ActiveInactiveServiceSpareParts extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ActiveInactiveServiceSpareParts() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (spdetails.size() > 0) {
			RequestDispatcher rd=request.getRequestDispatcher("./searchServiceSpareParts.jsp");
