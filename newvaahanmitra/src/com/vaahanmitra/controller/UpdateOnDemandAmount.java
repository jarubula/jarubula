...
/**
 * Servlet implementation class UpdateOnDemandAmount
 */
public class UpdateOnDemandAmount extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateOnDemandAmount() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String message1=sdao.UpdateOnDemandAmount(expCharges, waitingCharges, userId1);
		
		RequestDispatcher rd=request.getRequestDispatcher("./updateOnDemandAmount.jsp");
