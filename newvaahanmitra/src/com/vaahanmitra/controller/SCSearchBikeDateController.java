...
/**
 * Servlet implementation class SCSearchBikeDateController
 */
public class SCSearchBikeDateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(uvgr.size()>0)
		{
			pageName = "./scSearchBikeDateList.jsp";
