...
/**
 * Servlet implementation class SearchHUsedVehicleDealer
 */
public class SearchHUsedVehicleDealer extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchHUsedVehicleDealer() {
        super();
...
//		response.setHeader("Pragma", "no-cache"); // HTTP 1.0.
		...
		RequestDispatcher rd=request.getRequestDispatcher("./searchHUsedVehicleDealer.jsp");
