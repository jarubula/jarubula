...
/**
 * Servlet implementation class UsedVehicleGetRequesterController
 */
public class UsedVehicleGetRequesterController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsedVehicleGetRequesterController() {
        super();
...
String carId = request.getParameter("carId");
		...
		ArrayList<UsedVehicleGetRequester> uvgr= dao.getCarId(carId ,user_name);
		String count = dao.getCarCount(carId ,user_name);
		String page = null;
		if(uvgr.size()>0)
		{
			page = "./usedVehicleRequestList.jsp";
		...
		{	
			...
			page = "./usedVehicleGetRequester.jsp";
