...
/**
 * Servlet implementation class BusinessUsedBikeController
 */
@javax.servlet.annotation.MultipartConfig
public class BusinessUsedBikeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusinessUsedBikeController() {
        super();
