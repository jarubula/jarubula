...
/**
 * Servlet implementation class SearchServiceSpareParts
 */
public class SearchServiceSpareParts extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchServiceSpareParts() {
        super();
...
String jspPage = null;
		...
		if(spdetails.size()>0)
		{
			...
			jspPage = "./searchServiceSpareParts.jsp";  
