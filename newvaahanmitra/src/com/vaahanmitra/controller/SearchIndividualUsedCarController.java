...
/**
 * Servlet implementation class SearchIndividualUsedCarController
 */
public class SearchIndividualUsedCarController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SearchIndividualUsedCarController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			message = "CAR DETAILS";
			RequestDispatcher rd=request.getRequestDispatcher("./showIndividualUsedCar.jsp");  
		...
		{
			message = "*** No cars found <a href='./addIOUsedCar.jsp'>add your CAR </a> for sale***";
			RequestDispatcher rd=request.getRequestDispatcher("./searchIndividualUsedCar.jsp");
