...
/**
 * Servlet implementation class AddServiceSpareParts
 */
@javax.servlet.annotation.MultipartConfig
public class AddServiceSpareParts extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddServiceSpareParts() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (check.equals("success")) {
			...
			if(vehicleType.equals("4,")){
				page = "./serviceCarSpareParts.jsp";
			}else{
				page = "./serviceBikeSpareParts.jsp";
			}
		} else {
