...
/**
 * Servlet implementation class SCSearchCarDateController
 */
public class SCSearchCarDateController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SCSearchCarDateController() {
        super();
