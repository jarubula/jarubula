...
/**
 * Servlet implementation class IndividualUsedCarController
 */
@javax.servlet.annotation.MultipartConfig
public class IndividualUsedCarController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String SAVE_DIR="images";  
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IndividualUsedCarController() {
        super();
...
//			usedCar.setNO_OF_OWNERS(Integer.parseInt(request.getParameter("noOfOwners1")));
		...
		if (carNo == true) {
			...
			if (msg.equals("success")) {
				...
				page = "./successIndividualUsedCar.jsp";
			}else{
