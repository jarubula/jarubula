...
/**
 * Servlet implementation class ShowDashboard2UsedCarListController
 */
public class ShowDashboard2UsedCarListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowDashboard2UsedCarListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			message = "CAR DETAILS";
			RequestDispatcher rd=request.getRequestDispatcher("./showDashboard2UsedCarsList1.jsp");
		...
		{
			message = "*** No cars found <a href='./addUDUsedCar.jsp'>add your CAR </a> for sale***";
			RequestDispatcher rd=request.getRequestDispatcher("./showDashboard2UsedCarsList.jsp");
