...
/**
 * Servlet implementation class SearchIndividualUsedBikeController
 */
public class SearchIndividualUsedBikeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchIndividualUsedBikeController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			message = "*** No bikes found <a href='./addlOUsedBike.jsp'>add your BIKE </a> for sale***";
			jspPage = "./searchIndividualUsedBike.jsp";
