...
/**
 * Servlet implementation class SCSearchCarIdController
 */
public class SCSearchCarIdController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SCSearchCarIdController() {
        super();
