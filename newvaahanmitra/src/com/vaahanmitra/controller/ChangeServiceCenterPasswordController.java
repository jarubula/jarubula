...
/**
 * Servlet implementation class ChangeServiceCenterPasswordController
 */
public class ChangeServiceCenterPasswordController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeServiceCenterPasswordController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (newpwd.equals(repwd)) {
			...
			if(change == false){
				...
				RequestDispatcher rd = request.getRequestDispatcher("./changeServiceCenterPassword.jsp");
