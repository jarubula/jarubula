...
/**
 * Servlet implementation class ShowDriverEndUserBill
 */
public class ShowDriverEndUserBill extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ShowDriverEndUserBill() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String driverEmail=request.getParameter("demail");
