         ...
         <div class="wrapper">
               <div class="main" style="padding-right: 2px;" id="b0">
                <div class="col-md-12 main1" style="padding: 0 0;">
	               ...
	               <div class="modal-body">
	                <iframe frameBorder="0" class="col-md-12 col-sm-12 col-xs-12" src="slidernew.html"  style="min-height:440px; background: #fff;"></iframe>
              ...
              <!--=========== end popup ======= -->
                      ...
                      <!--================== center section ===================-->       
                        ...
                        <div class="clearfix"></div>  
				         <div class="sidebar alert  alert-dismissible" id="sidebar" style="padding: 16px 0;">
