     ...
     <img src='images/cancel.png' alt='quit' class='x' id='x' />
        ...
        <!--================= end header section ==================-->     
               ...
               <div class="main" style="padding-right: 2px;" id="b0">
                <div class="col-md-12 main1" style="padding: 0 0;">
                     ...
                     <!--================== center section ===================--> 
							 ...
							 <div class="col-md-12 search11" id="to5">
							   <div class="col-md-12 search3">
							   <span class="search2"> ${bikeal.NEW_BIKE_ID} > <a href="#" class="to" data-toggle="modal" data-target="#myModal">View Images</a></span>
							   </div>
						       <div class="col-md-11">
							   <span> 
         ...
         <!--============= scoical Section ================--> 
              ...
              <!-- ====== popup section ========-->
               <div class="modal fade" id="myModal" role="dialog" style="background:#333333b5 !impprtant;;">
